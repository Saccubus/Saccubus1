...
　・1.22r3e7 (2011/8/12)　セッション共有、Chromium,その他追加
...
　既にさきゅばすを使用中の方
　・Saccubus.jarを差し替えます。
　・1.22r3e7のbinフォルダ内のファイルを使用中のbinフォルダに
　　コピーして下さい。
...
　・1.22r3e7を1.22r3を展開したフォルダにコピーします。
