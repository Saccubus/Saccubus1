...
の３４１氏のものを元にNicoBrowser拡張1.4.4（作者：雪羽氏）の
一部機能を借用して改造しました。
...
　　optionフォルダ　が必要です。
　　*** 同梱していません ***
　・1.22r3e2を1.22r3を展開したフォルダにコピーします。
...
　　(git-N-30117)、及び、前スレ>>341(SVN-21400)で行いました。
...
・readme1.22r3e2.txt、readme.txt(1.22r)、readme+.txt(1.22r3)
・saccubus1.22r3e2_src.zip
　　1.22r3e2 javaソースファイル、eclipseプロジェクトファイル
