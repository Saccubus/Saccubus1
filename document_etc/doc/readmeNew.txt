...
　　r　dmc(R)ダウンロード　HTTP/1.1のRangeヘッダを使い前半と後半を同時に
　　 　　　　　　　　　　　ダウンロードする。　同時接続数２
　　s　dmc(S)ダウンロード　約１分間読み込んでダウンロード速度が遅くなったら接続を切り
　　 　　　　　　　　　　　約１分間を待って続きからresumeする。　同時接続数１
　　 　　　　　　　　　　　やや不安定で長い動画はエラーになりやすい。
　　どちらもdmcサーバだけ適用です。
　　L　Large固定　　　　　サイズ大きい方のダウンロードに失敗しても小さい動画に
　　　　　　　　　　　　　アクセスせずエラー終了します。
