...
:メールアドレス使用時は従来通りのパスワードに加え半角１文字の ! が使用出来ます。
:さきゅばすが自動でsaccubus.xmlの暗号化パスワードから復号します。
...
:%CMD% sm1 000000
%CMD% sm30155744 000000 @PUP WatchHtml5=true Html5CommentMode=true ShadowIndex=6

:%CMD% http://www.nicovideo.jp/watch/1329021499 000000 -s=640x360 QAddOption="-vf scale=640:360,pad=686:384:23:3,@,crop=672:372:7:0" @PUP WatchHtml5=false

:記述法(2)
:↓のままでOK。過去ログは000000を変更。
%CMD% autotest?watch_harmful=1 000000 @PUP
