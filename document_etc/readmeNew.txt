...
　・1.26α2 (2011/10/05)　チャンネル・コミュニティ動画とその過去ログを
　　新コメント表示（毎分最新１００コメ、合計１０００コメント以上）
...
　　ユーザー　　　過去　旧表示＊　注①＊　　無し
　・制限事項
　　＊印のところがブラウザの既定表示と違います。
　　注①：最新の1000コメントを取得します。
　　新表示と旧表示の切り替えが出来ません。（ブラウザ・いんきゅばすは可能）
　　　旧表示：動画の長さに合わせた最新コメント数。10分で最大1000コメント
　　　新表示：毎分最新100コメント＋旧表示

　■本機能は「いんきゅばす1.7.2」とcoroid project wikiを参考にしました。
　　感謝。以下に説明があります。
...
■機能確認
　・ブラウザのセッション共有機能確認は
　　Win7 Home 32bit + IE9, Firefox5.0-6.1, Chrome13, SRware 及び
　　XP SP3 Home 32bit + IE8, Firefox5.0-6.1, Chrome13, SRware
　　で行いました。
