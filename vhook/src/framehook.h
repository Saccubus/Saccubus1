...
#define FRAMEHOOK_OPT_CHANGE_SIMSUN_UNICODE	"--change-simsun-unicode:"
#define FRAMEHOOK_OPT_CHANGE_SIMSUN_UNICODE_LEN	strlen(FRAMEHOOK_OPT_CHANGE_SIMSUN_UNICODE)

#define FRAMEHOOK_OPT_CHANGE_GULIM_UNICODE	"--change-gulim-unicode:"
#define FRAMEHOOK_OPT_CHANGE_GULIM_UNICODE_LEN	strlen(FRAMEHOOK_OPT_CHANGE_GULIM_UNICODE)

#define FRAMEHOOK_OPT_PROTECT_GOTHIC_UNICODE	"--protect-gothic-unicode:"
#define FRAMEHOOK_OPT_PROTECT_GOTHIC_UNICODE_LEN	strlen(FRAMEHOOK_OPT_PROTECT_GOTHIC_UNICODE)

#define FRAMEHOOK_OPT_ZERO_WIDTH_UNICODE	"--zero-width-unicode:"
#define FRAMEHOOK_OPT_ZERO_WIDTH_UNICODE_LEN	strlen(FRAMEHOOK_OPT_ZERO_WIDTH_UNICODE)
