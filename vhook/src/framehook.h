...
#define FRAMEHOOK_OPT_DOUBLE_RESIZE_WIDTH	"--double-resize-width:"
#define FRAMEHOOK_OPT_DOUBLE_RESIZE_WIDTH_LEN	strlen(FRAMEHOOK_OPT_DOUBLE_RESIZE_WIDTH)
...
#define FRAMEHOOK_OPT_DEBUG_KEY	"--debug-key:"
#define FRAMEHOOK_OPT_DEBUG_KEY_LEN	strlen(FRAMEHOOK_OPT_DEBUG_KEY)
