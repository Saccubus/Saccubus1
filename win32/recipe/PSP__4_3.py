...
def cmdline(info):
	return "{ffmpeg} -y {sacc} -flags +bitexact -vcodec libx264 -coder 1 -bufsize 128k -g 250 -s 720x480 -r 29.97 -qscale 1 -maxrate 3000k -acodec libvo_aacenc -ac 2 -ar 44100 -ab 192k -absf aac_adtstoasc -f psp -level 21 -aspect 4:3 -qcomp 0.7 -qmin 10 -qmax 51 -qdiff 4 -subq 6 -me_range 16 -i_qfactor 0.714286 \"{resource_path}/{out}.mp4\"".format(ffmpeg=info['ffmpeg-file'], sacc=info['saccubus-opts'], resource_path=info['resource-path'], out=info['out-file-base'])
