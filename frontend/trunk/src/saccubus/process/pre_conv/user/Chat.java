...
public class Chat {
	...
	protected void setDate(String date_str) {
		Date = Integer.parseInt(date_str);
		// System.out.println("date:" + date_str);
	}

	protected void setMail(String mail_str) {
	...
	protected void setNo(String no_str) {
		try {
	...
	protected void setUserID(String user_id_str) {
	...
	protected void setVpos(String vpos_str) {
	...
	protected void setComment(String com_str) {
	...
	protected void write(OutputStream os) throws IOException {
		...
		IOUtil.writeInt(os, Location);
		IOUtil.writeInt(os, Size);
		IOUtil.writeInt(os, Color);
		IOUtil.writeInt(os, a.length);
		try {
			os.write(a);
