...
public class MainFrame extends JFrame {
	...
	JPanel basePanel = getBasePanel();
	JMenuBar jMenuBar1 = getJMenuBar1();
	JMenu jMenuFile = getJMenuFile();
	JMenuItem jMenuFileExit = getJMenuFileExit();
	JMenu jMenuHelp = getJMenuHelp();
	JMenuItem jMenuHelpAbout = getJMenuHelpAbout();
	JLabel statusBar = getStatusBar();
	JLabel elapsedTimeBar = getElapsedTimeBar();
	JLabel vhookInfoBar = getVhookInfoBar();
	JLabel infoBar = getInfoBar();
	JTabbedPane MainTabbedPane = getMainTabbedPane();
	JPanel SavingInfoTabPanel = getSavingInfoTabPanel();
	JPanel FFMpegInfoTabPanel = getFFMpegInfoTabPanel();
	JPanel FFMpegTabPanel = getFFMpegTabPanel();
	JPanel FFMpegTab2Panel = getFFMpegTab2Panel();
	JPanel VideoInfoPanel = getVideoInfoPanel();
	JPanel StatusPanel = getStatusPanel();
	JTextField VideoID_TextField = getVideoID_TextField();
	JButton DoButton = getDoButton();
	JPanel UserInfoPanel = getUserInfoPanel();
	JLabel MailAddrLabel = getMailAddrLabel();
	JTextField MailAddrField = getMailAddrField();
	JLabel PasswordLabel = getPasswordLabel();
	JPasswordField PasswordField = getPasswordField();
	JPanel CommentSaveInfoPanel = getCommentSaveInfoPanel();
	JPanel OwnerCommentInfoPanel = getOwnerCommentInfoPanel();
	JCheckBox SavingVideoCheckBox = getSavingVideoCheckBox();
	JTextField VideoSavedFileField = getVideoSavedFileField();
	JButton ShowSavingVideoFileDialogButton = getShowSavingVideoFileDialogButton();
	JCheckBox SavingCommentCheckBox = getSavingCommentCheckBox();
	JTextField CommentSavedFileField = getCommentSavedFileField();
	JCheckBox AddTimeStampToCommentCheckBox = getAddTimeStampToCommentCheckBox();
	JCheckBox SavingOwnerCommentCheckBox = getSavingOwnerCommentCheckBox();
	JLabel OwnerCommentNoticeLabel1 = getOwnerCommentNoticeLabel1();
	JButton ShowSavingCommentFileDialogButton = getShowSavingCommentFileDialogButton();
	JPanel ConvertedVideoSavingInfoPanel = getConvertedVideoSavingInfoPanel();
	JCheckBox SavingConvertedVideoCheckBox = getSavingConvertedVideoCheckBox();
	JCheckBox ConvertWithCommentCheckBox = getConvertWithCommentCheckBox();
	JCheckBox ConvertWithOwnerCommentCheckBox = getConvertWithOwnerCommentCheckBox();
	JCheckBox AddOption_ConvVideoFileCheckBox = getAddOption_ConvVideoFileCheckBox();
	JTextField ConvertedVideoSavedFileField = getConvertedVideoSavedFileField();
	JButton ShowSavingConvertedVideoFileDialogButton = getShowSavingConvertedVideoFileDialogButton();
	JPanel CheckFFmpegFunctionPanel = getCheckFFmpegFunctionPanel();
	JButton CheckFFmpegVersionButton = getCheckFFmpegVersionButton();
	JLabel CheckFFmpegVersionLabel = getCheckFFmpegVersionLabel();
	JTextArea TextFFmpegOutput = getTextFFmpegOutput();
	JButton CheckDownloadVideoButton = getCheckDownloadVideoButton();
	JLabel CheckDownloadVideoLabel = getCheckDownloadVideoLabel();
	JPanel BrowserInfoPanel = getBrowserInfoPanel();
	JLabel BrowserInfoLabel = getBrowserInfoLabel();
	JCheckBox BrowserIECheckBox = getBrowserIECheckBox();
	JCheckBox BrowserFFCheckBox = getBrowserFFCheckBox();
	JCheckBox BrowserChromeCheckBox = getBrowserChromeCheckBox();
	JCheckBox BrowserOperaCheckBox = getBrowserOperaCheckBox();
	JCheckBox BrowserChromiumCheckBox = getBrowserChromiumCheckBox();
	JCheckBox BrowserOtherCheckBox = getBrowserOtherCheckBox();
	JButton BrowserCookieDialogButton = getBrowserCookieDialogButton();
	JTextField BrowserCookieField = getBrowserCookieField();
	JPanel OptionalThreadInfoPanel = getOptionalThreadInfoPanel();
	JLabel OptionalthreadLabel = getOptionalthreadLabel();
	JCheckBox OptionalTranslucentCheckBox = getOptionalTranslucentCheckBox();

	JPanel PathSettingPanel = getPathSettingPanel();
	JPanel VhookPathSettingPanel = getVhookPathSettingPanel();
	JPanel FFmpegPathSettingPanel = getFFmpegPathSettingPanel();
	JLabel FFmpegPathLabel = getFFmpegPathLabel();
	JLabel OptionPathLabel = getOptionPathLabel();
	JTextField FFmpegPathField = getFFmpegPathField();
	JTextField OptionPathField = getOptionPathField();
	JButton SettingFFmpegPathButton = getSettingFFmpegPathButton();
	JButton SettingOptionPathButton = getSettingOptionPathButton();
	JLabel VhookSettingLabel = getVhookSettingLabel();
	JLabel VhookPathLabel = getVhookPathLabel();
	JLabel VhookWidePathLabel = getVhookWidePathLabel();
	JCheckBox UseVhookCheckBox = getUseVhookCheckBox();
	JCheckBox UseVhookWideCheckBox = getUseVhookWideCheckBox();
	JTextField VhookPathField = getVhookPathField();
	JTextField VhookWidePathField = getVhookWidePathField();
	JButton SettingVhookPathButton = getSettingVhookPathButton();
	JButton SettingVhookWidePathButton = getSettingVhookWidePathButton();
	JPanel VhookSettingPanel = getVhookSettingPanel();
	JPanel FFmpegSettingPanel = getFFmpegSettingPanel();
	JPanel WideFFmpegSettingPanel = getWideFFmpegSettingPanel();
	JLabel FontPathLabel = getFontPathLabel();
	JTextField FontPathField = getFontPathField();
	JButton SettingFontPathButton = getSettingFontPathButton();
	JCheckBox ShowConvVideoCheckBox = getShowConvVideoCheckBox();

	JTextField CommandLineOutOptionField = getCommandLineOutOptionField();
	JTextField CommandLineInOptionField = getCommandLineInOptionField();
	JLabel InLabel = getInLabel();
	JLabel OutLabel = getOutLabel();
	JLabel CommentNumLabel = getCommentNumLabel();
	JTextField CommentNumField = getCommentNumField();
	JLabel MainOptionLabel = getMainOptionLabel();
	JTextField MainOptionField = getMainOptionField();
	JLabel FontIndexLabel = getFontIndexLabel();
	JTextField FontIndexField = getFontIndexField();
	JLabel VideoID_Label = getVideoID_Label();
	JLabel WayBackLabel = getWayBackLabel();
	JTextField WayBackField = getWayBackField();
	JPanel OpPanel = getOpPanel();
	JRadioButton Conv_SaveFileRadioButton = getConv_SaveFileRadioButton();
	JRadioButton Conv_SaveFolderRadioButton = getConv_SaveFolderRadioButton();
	JTextField ConvertedVideoSavedFolderField = getConvertedVideoSavedFolderField();
	JButton ShowSavingConvertedVideoFolderDialogButton = getShowSavingConvertedVideoFolderDialogButton();
	JTextField VideoSavedFolderField = getVideoSavedFolderField();
	JButton ShowSavingVideoFolderDialogButton = getShowSavingVideoFolderDialogButton();
	JRadioButton Video_SaveFolderRadioButton = getVideo_SaveFolderRadioButton();
	JRadioButton Video_SaveFileRadioButton = getVideo_SaveFileRadioButton();
	JRadioButton Comment_SaveFileRadioButton = getComment_SaveFileRadioButton();
	JTextField CommentSavedFolderField = getCommentSavedFolderField();
	JButton ShowSavingCommentFolderDialogButton = getShowSavingCommentFolderDialogButton();
	JRadioButton Comment_SaveFolderRadioButton = getComment_SaveFolderRadioButton();
	JPanel BasicInfoTabPanel = getBasicInfoTabPanel();
	JTextField wideExtOptionField = getWideExtOptionField();
	JTextField wideMainOptionField = getWideMainOptionField();
	JTextField wideCommandLineInOptionField = getWideCommandLineInOptionField();
	JTextField wideCommandLineOutOptionField = getWideCommandLineOutOptionField();
	JPanel experimentPanel = getExperimentPanel();
	JCheckBox fontHeightFixCheckBox = getFontHeightFixCheckBox();
	JLabel fontHeightRatioLabel = getFontHeightRatioLabel();
	JTextField fontHeightRatioTextField = getFontHeightRatioTextField();
	//0--------1---------2---------3---------4-------(up left down right)
	...
	private void initComponents() {
		setTitle("さきゅばす 1.27.beta.0");
		setDefaultCloseOperation(WindowConstants.EXIT_ON_CLOSE);
		basePanel.setLayout(new BorderLayout());
		basePanel.add(getStatusPanel(), BorderLayout.SOUTH);
		basePanel.add(getMainTabbedPane(), BorderLayout.CENTER);
		basePanel.add(getVideoInfoPanel(), BorderLayout.NORTH);
		setJMenuBar(getJMenuBar1());
		initVideoSaveButtonGroup();
		initCommentSaveButtonGroup();
		initConvSaveButtonGroup();
		setSize(400, 625);
	}

	private void initConvSaveButtonGroup() {
		ConvSaveButtonGroup = new ButtonGroup();
		ConvSaveButtonGroup.add(getConv_SaveFileRadioButton());
		ConvSaveButtonGroup.add(getConv_SaveFolderRadioButton());
	}

	private void initCommentSaveButtonGroup() {
		CommentSaveButtonGroup = new ButtonGroup();
		CommentSaveButtonGroup.add(getComment_SaveFileRadioButton());
		CommentSaveButtonGroup.add(getComment_SaveFolderRadioButton());
	}

	private void initVideoSaveButtonGroup() {
		VideoSaveButtonGroup = new ButtonGroup();
		VideoSaveButtonGroup.add(getVideo_SaveFileRadioButton());
		VideoSaveButtonGroup.add(getVideo_SaveFolderRadioButton());
	}
	...
	// Visual Swing for Eclipse 用に追加されたSwing個別初期化
	// get<Swing変数名>()メソッドが必要なため単に new しているだけ
	// →勝手に書き換えられてしまった。
	// 　↓↓　ここから　↓↓
	private JTextField getFontHeightRatioTextField() {
		return new JTextField();
	}

	private JLabel getFontHeightRatioLabel() {
		return new JLabel();
	}

	private JCheckBox getFontHeightFixCheckBox() {
		if (fontHeightFixCheckBox == null) {
			fontHeightFixCheckBox = new JCheckBox();
			fontHeightFixCheckBox.setForeground(Color.blue);
			fontHeightFixCheckBox.setSelected(true);
			fontHeightFixCheckBox.setText("フォントの高さを調整する");
		}
		return fontHeightFixCheckBox;
	}

	private JPanel getExperimentPanel() {
		if (experimentPanel == null) {
			experimentPanel = new JPanel();
			experimentPanel.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(EtchedBorder.LOWERED, null, null), "実験的設定",
					TitledBorder.LEADING, TitledBorder.TOP, new Font("Dialog", Font.BOLD, 12), Color.blue));
			experimentPanel.setLayout(new GridBagLayout());
			experimentPanel.add(getFontHeightRatioLabel());
			experimentPanel.add(getFontHeightRatioTextField());
			experimentPanel.add(getFontHeightFixCheckBox());
			experimentPanel.add(getJLabel0());
		}
	...
	private JCheckBox getOptionalTranslucentCheckBox() {
		return new JCheckBox();
	}

	private JLabel getOptionalthreadLabel() {
		return new JLabel();
	}

	private JPanel getOptionalThreadInfoPanel() {
		return new JPanel();
	}

	private JTextField getBrowserCookieField() {
		return new JTextField();
	}

	private JButton getBrowserCookieDialogButton() {
		return new JButton();
	}

	private JCheckBox getBrowserOtherCheckBox() {
		return new JCheckBox();
	}

	private JCheckBox getBrowserChromiumCheckBox() {
		return new JCheckBox();
	}

	private JCheckBox getBrowserOperaCheckBox() {
		return new JCheckBox();
	}

	private JCheckBox getBrowserChromeCheckBox() {
		return new JCheckBox();
	}

	private JCheckBox getBrowserFFCheckBox() {
		return new JCheckBox();
	}

	private JCheckBox getBrowserIECheckBox() {
		return new JCheckBox();
	}

	private JLabel getBrowserInfoLabel() {
		return new JLabel();
	}

	private JPanel getBrowserInfoPanel() {
		return new JPanel();
	}

	private JLabel getCheckDownloadVideoLabel() {
		return new JLabel();
	}

	private JButton getCheckDownloadVideoButton() {
		return new JButton();
	}

	private JTextArea getTextFFmpegOutput() {
		return new JTextArea();
	}

	private JLabel getCheckFFmpegVersionLabel() {
		return new JLabel();
	}

	private JButton getCheckFFmpegVersionButton() {
		return new JButton();
	}

	private JPanel getCheckFFmpegFunctionPanel() {
		return new JPanel();
	}

	private JTextField getConvertedVideoSavedFileField() {
		return new JTextField();
	}

	private JCheckBox getAddOption_ConvVideoFileCheckBox() {
		return new JCheckBox();
	}

	private JCheckBox getConvertWithOwnerCommentCheckBox() {
		return new JCheckBox();
	}

	private JCheckBox getConvertWithCommentCheckBox() {
		return new JCheckBox();
	}

	private JCheckBox getSavingConvertedVideoCheckBox() {
		return new JCheckBox();
	}

	private JPanel getConvertedVideoSavingInfoPanel() {
		return new JPanel();
	}

	private JButton getShowSavingCommentFileDialogButton() {
		return new JButton();
	}

	private JLabel getOwnerCommentNoticeLabel1() {
		return new JLabel();
	}

	private JCheckBox getSavingOwnerCommentCheckBox() {
		return new JCheckBox();
	}

	private JCheckBox getAddTimeStampToCommentCheckBox() {
		return new JCheckBox();
	}

	private JTextField getCommentSavedFileField() {
		return new JTextField();
	}

	private JCheckBox getSavingCommentCheckBox() {
		return new JCheckBox();
	}

	private JButton getShowSavingVideoFileDialogButton() {
		return new JButton();
	}

	private JButton getShowSavingConvertedVideoFileDialogButton() {
		return new JButton();
	}

	private JTextField getVideoSavedFileField() {
		return new JTextField();
	}

	private JCheckBox getSavingVideoCheckBox() {
		return new JCheckBox();
	}

	private JPanel getOwnerCommentInfoPanel() {
		return new JPanel();
	}

	private JPanel getCommentSaveInfoPanel() {
		return new JPanel();
	}
	...
	private JTextField getMailAddrField() {
		return new JTextField();
	}

	private JLabel getMailAddrLabel() {
		return new JLabel();
	}
	...
	private JTextField getVideoID_TextField() {
		return new JTextField();
	}
	...
	private JPanel getStatusPanel() {
		if (StatusPanel == null) {
			...
			StatusPanel.add(getElapsedTimeBar());
			StatusPanel.add(getVhookInfoBar());
			StatusPanel.add(getStatusBar());
		}
		return StatusPanel;
	}

	private JPanel getVideoInfoPanel() {
		return new JPanel();
	}

	private JPanel getFFMpegTab2Panel() {
		return new JPanel();
	}

	private JPanel getFFMpegTabPanel() {
		return new JPanel();
	}

	private JPanel getFFMpegInfoTabPanel() {
		return new JPanel();
	}

	private JPanel getSavingInfoTabPanel() {
		return new JPanel();
	}
	...
	private JTabbedPane getMainTabbedPane() {
		if (MainTabbedPane == null) {
			...
			MainTabbedPane.addTab("基本設定", getBasicInfoTabPanel());
			MainTabbedPane.addTab("保存設定", getSavingInfoTabPanel());
			MainTabbedPane.addTab("動画設定", getFFMpegInfoTabPanel());
			MainTabbedPane.addTab("変換設定", getConvertingSettingPanel());
		}
		return MainTabbedPane;
	}

	private JLabel getInfoBar() {
		return new JLabel();
	}

	private JLabel getVhookInfoBar() {
		return new JLabel();
	}

	private JLabel getElapsedTimeBar() {
		return new JLabel();
	}
	...
	private JMenuItem getJMenuHelpAbout() {
	...
	private JTextField getCommandLineOutOptionField() {
		return new JTextField();
	}

	private JCheckBox getShowConvVideoCheckBox() {
		return new JCheckBox();
	}

	private JButton getSettingFontPathButton() {
		return new JButton();
	}

	private JTextField getFontPathField() {
		return new JTextField();
	}

	private JLabel getFontPathLabel() {
		return new JLabel();
	}

	private JPanel getWideFFmpegSettingPanel() {
		return new JPanel();
	}

	private JPanel getFFmpegSettingPanel() {
		return new JPanel();
	}
	...
	private JButton getSettingVhookWidePathButton() {
		return new JButton();
	}

	private JButton getSettingVhookPathButton() {
		return new JButton();
	}

	private JTextField getVhookWidePathField() {
		return new JTextField();
	}

	private JTextField getVhookPathField() {
		return new JTextField();
	}

	private JCheckBox getUseVhookWideCheckBox() {
		return new JCheckBox();
	}

	private JCheckBox getUseVhookCheckBox() {
		return new JCheckBox();
	}

	private JLabel getVhookWidePathLabel() {
		return new JLabel();
	}

	private JLabel getVhookPathLabel() {
		return new JLabel();
	}

	private JLabel getVhookSettingLabel() {
		return new JLabel();
	}

	private JButton getSettingOptionPathButton() {
		return new JButton();
	}

	private JButton getSettingFFmpegPathButton() {
		return new JButton();
	}

	private JTextField getOptionPathField() {
		return new JTextField();
	}

	private JTextField getFFmpegPathField() {
		return new JTextField();
	}

	private JLabel getOptionPathLabel() {
		return new JLabel();
	}

	private JLabel getFFmpegPathLabel() {
		return new JLabel();
	}

	private JPanel getFFmpegPathSettingPanel() {
		return new JPanel();
	}

	private JPanel getVhookPathSettingPanel() {
		return new JPanel();
	}

	private JPanel getPathSettingPanel() {
		return new JPanel();
	}

	private JTextField getWideCommandLineOutOptionField() {
		return new JTextField();
	}

	private JTextField getWideCommandLineInOptionField() {
		return new JTextField();
	}

	private JTextField getWideMainOptionField() {
		return new JTextField();
	}

	private JTextField getWideExtOptionField() {
		return new JTextField();
	}

	private JPanel getBasicInfoTabPanel() {
		return new JPanel();
	}

	private JRadioButton getComment_SaveFolderRadioButton() {
		return new JRadioButton();
	}

	private JButton getShowSavingCommentFolderDialogButton() {
		return new JButton();
	}

	private JTextField getCommentSavedFolderField() {
		return new JTextField();
	}

	private JRadioButton getComment_SaveFileRadioButton() {
		return new JRadioButton();
	}

	private JRadioButton getVideo_SaveFileRadioButton() {
		return new JRadioButton();
	}

	private JRadioButton getVideo_SaveFolderRadioButton() {
		return new JRadioButton();
	}

	private JButton getShowSavingVideoFolderDialogButton() {
		return new JButton();
	}

	private JTextField getVideoSavedFolderField() {
		return new JTextField();
	}

	private JButton getShowSavingConvertedVideoFolderDialogButton() {
		return new JButton();
	}

	private JTextField getConvertedVideoSavedFolderField() {
		return new JTextField();
	}

	private JRadioButton getConv_SaveFolderRadioButton() {
		return new JRadioButton();
	}

	private JRadioButton getConv_SaveFileRadioButton() {
		return new JRadioButton();
	}

	private JPanel getOpPanel() {
		return new JPanel();
	}

	private JTextField getWayBackField() {
		return new JTextField();
	}

	private JLabel getWayBackLabel() {
		return new JLabel();
	}

	private JLabel getVideoID_Label() {
		return new JLabel();
	}

	private JTextField getFontIndexField() {
		return new JTextField();
	}

	private JLabel getFontIndexLabel() {
		return new JLabel();
	}

	private JTextField getMainOptionField() {
		return new JTextField();
	}

	private JLabel getMainOptionLabel() {
		return new JLabel();
	}

	private JTextField getCommentNumField() {
		return new JTextField();
	}

	private JLabel getCommentNumLabel() {
		return new JLabel();
	}
	...
	private JTextField getCommandLineInOptionField() {
		return new JTextField();
	}

	private JLabel getShadowKindLabel() {
		return new JLabel();
	}

	private JLabel getViewCommentLabel() {
		return new JLabel();
	}

	private JLabel getExtOptionLabel() {
		return new JLabel();
	}

	private JTabbedPane getFFmpegInfoTabPaneEach() {
	 ...
	 */
	public static void psudomain(String[] args) {
		installLnF();
	...
	private void jbInit() throws Exception {
		...
		ShadowKindLabel = getShadowKindLabel();
		ShadowKindLabel.setText("影の種類");
		ShadowKindLabel.setDisplayedMnemonic(KeyEvent.VK_UNDEFINED);
		GridBagConstraints grid1_x1_y0_71 = new GridBagConstraints(1, 0, 1, 1,
		...
		ViewCommentLabel = getViewCommentLabel();
		...
		GridBagConstraints grid8_x4_y3_64 = new GridBagConstraints(1, 1, 1, 1,
				0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH,
				INSETS_0_0_0_5, 0, 0);
		grid8_x4_y3_64.gridy = 3;
		grid8_x4_y3_64.fill = GridBagConstraints.HORIZONTAL;
		grid8_x4_y3_64.gridx = 4;
		GridBagConstraints grid8_x0_y7_63 = new GridBagConstraints(0, 4, 2, 1,
		...
		GridBagConstraints grid8_x1_y5_62 = new GridBagConstraints(0, 3, 2, 1,
		...
		GridBagConstraints grid8_x0_y5_61 = new GridBagConstraints(0, 2, 1, 1,
				0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH,
				INSETS_5_5_5_5, 0, 0);
		...
		GridBagConstraints grid8_x1_y3_60 = new GridBagConstraints(0, 1, 1, 1,
				1.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH,
				INSETS_0_5_0_5, 0, 0);
		...
		GridBagConstraints grid8_x0_y3_59 = new GridBagConstraints(0, 0, 2, 1,
				1.0, 0.0, GridBagConstraints.CENTER,
		...
		ExtOptionLabel = getExtOptionLabel();
		...
		GridBagConstraints grid9_x1_y5_53 = new GridBagConstraints(1, 3, 2, 1,
				1.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH,
				INSETS_0_0_5_5, 0, 0);
		...
		GridBagConstraints grid9_x1_y4_52 = new GridBagConstraints(2, 2, 1, 1,
				1.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH,
				INSETS_0_0_5_5, 0, 0);
		...
		GridBagConstraints grid9_x1_y3_51 = new GridBagConstraints(2, 1, 1, 1,
				1.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH,
				INSETS_0_0_5_5, 0, 0);
		...
		GridBagConstraints grid9_x0_y5_50 = new GridBagConstraints(0, 3, 1, 1,
				0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.BOTH,
				INSETS_0_5_5_5, 0, 0);
		grid9_x0_y5_50.gridy = 5;
		GridBagConstraints grid9_x0_y4_49 = new GridBagConstraints(0, 2, 2, 1,
				0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.BOTH,
				INSETS_0_5_5_5, 0, 0);
		grid9_x0_y4_49.gridy = 4;
		grid9_x0_y4_49.gridwidth = 1;
		GridBagConstraints grid9_x0_y3_48 = new GridBagConstraints(0, 1, 1, 1,
				0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.BOTH,
				INSETS_0_5_5_5, 0, 0);
		grid9_x0_y3_48.gridy = 3;
		GridBagConstraints grid5_x3_y8_45 = new GridBagConstraints(3, 5, 1, 1,
				0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE,
				INSETS_0_0_5_5, 0, 0);
		grid5_x3_y8_45.gridy = 8;
		GridBagConstraints grid5_x3_y6_44 = new GridBagConstraints(3, 3, 1, 1,
				0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE,
				INSETS_0_0_0_5, 0, 0);
		grid5_x3_y6_44.gridy = 6;
		GridBagConstraints grid5_x0_y8_43 = new GridBagConstraints(0, 5, 3, 1,
				1.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH,
				new Insets(3, 50, 5, 5), 0, 0);
		grid5_x0_y8_43.gridy = 8;
		GridBagConstraints grid5_x0_y7_42 = new GridBagConstraints(0, 4, 4, 1,
				1.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE,
				new Insets(0, 25, 0, 5), 0, 0);
		grid5_x0_y7_42.gridy = 7;
		GridBagConstraints grid5_x0_y6_41 = new GridBagConstraints(0, 3, 3, 1,
				0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH,
		...
		GridBagConstraints grid5_x0_y3_40 = new GridBagConstraints(0, 2, 4, 1,
				1.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE,
				new Insets(0, 25, 0, 5), 0, 0);
		...
		GridBagConstraints grid4_x3_y14_24 = new GridBagConstraints(3, 10, 1,
				1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.NONE, INSETS_0_0_5_5, 0, 0);
		grid4_x3_y14_24.gridy = 14;
		GridBagConstraints grid4_x3_y12_23 = new GridBagConstraints(3, 8, 1, 1,
				0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE,
				INSETS_0_0_0_5, 0, 0);
		grid4_x3_y12_23.gridy = 12;
		GridBagConstraints grid4_x1_y10_22 = new GridBagConstraints(1, 6, 4, 1,
				1.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH,
				INSETS_0_0_0_5, 0, 0);
		grid4_x1_y10_22.gridy = 10;
		GridBagConstraints grid4_x0_y14_21 = new GridBagConstraints(0, 10, 3,
				1, 1.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 50, 5, 5), 0, 0);
		grid4_x0_y14_21.gridy = 14;
		GridBagConstraints grid4_x0_y13_20 = new GridBagConstraints(0, 9, 4, 1,
				1.0, 0.0, GridBagConstraints.WEST,
				GridBagConstraints.HORIZONTAL, new Insets(0, 25, 0, 5), 0, 0);
		grid4_x0_y13_20.gridy = 13;
		GridBagConstraints grid4_x0_y12_19 = new GridBagConstraints(0, 8, 3, 1,
				1.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH,
				new Insets(0, 50, 0, 5), 0, 0);
		grid4_x0_y12_19.gridy = 12;
		GridBagConstraints grid4_x0_y11_18 = new GridBagConstraints(0, 7, 4, 1,
				1.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(0, 25, 0, 5), 0, 0);
		grid4_x0_y11_18.gridy = 11;
		GridBagConstraints grid4_x0_y10_17 = new GridBagConstraints(0, 6, 1, 1,
				0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH,
				INSETS_0_5_0_5, 0, 0);
		grid4_x0_y10_17.gridy = 10;
		grid4_x0_y10_17.insets = new Insets(0, 50, 0, 5);
		GridBagConstraints grid4_x0_y6_16 = new GridBagConstraints(0, 5, 4, 1,
		...
		GridBagConstraints grid12_x0_y0_7 = new GridBagConstraints(0, 0, 1, 1,
		...
		UserInfoPanel.setBorder(BorderFactory.createTitledBorder(
				BorderFactory.createEtchedBorder(), "ユーザ設定"));
		...
		BrowserInfoLabel
				.setToolTipText("メールアドレス、パスワードは入力不要（指定ブラウザがログインしていないとエラー）");
		...
		AddTimeStampToCommentCheckBox
				.setText("コメントファイル名に日時を付加する（フォルダを指定した時のみ）");
		...
		AddOption_ConvVideoFileCheckBox
				.setText("サブフォルダを作りFFmpeg設定をファイル名に（デバッグ用）");
		...
		SettingOptionPathButton.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				SettingOptionPathButton_actionPerformed(e);
			}
		});
		...
		WideFFmpegSettingPanel.setBorder(BorderFactory.createTitledBorder(
				BorderFactory.createEtchedBorder(EtchedBorder.LOWERED),
				"FFmpegの設定２ （拡張Vhook ワイドを選択した時）", TitledBorder.LEADING,
		...
		basePanel.add(MainTabbedPane, BorderLayout.CENTER);
		basePanel.add(VideoInfoPanel, BorderLayout.NORTH);
		...
		UserInfoPanel.add(MailAddrLabel, new GridBagConstraints(0, 0, 1, 1,
				0.0, 0.0, GridBagConstraints.EAST, GridBagConstraints.NONE,
				new Insets(0, 5, 5, 0), 0, 0));
		PathSettingPanel.add(OptionPathField, new GridBagConstraints(0, 1, 2,
				1, 1.0, 0.0, GridBagConstraints.CENTER,
		...
		// option wide(16:9)
		WideFFmpegSettingPanel.add(getWideFFmpegOptionComboBoxPanel(),
				grid9_x0_y1_55);
		WideFFmpegSettingPanel.add(new JLabel(ExtOptionLabel.getText()),
				grid9_x0_y2_56);
		WideFFmpegSettingPanel.add(wideExtOptionField, grid9_x1_y2_57);
		WideFFmpegSettingPanel.add(new JLabel(MainOptionLabel.getText()),
				grid9_x0_y3_48);
		WideFFmpegSettingPanel.add(wideMainOptionField, grid9_x1_y3_51);
		WideFFmpegSettingPanel.add(new JLabel(InLabel.getText()),
				grid9_x0_y4_49);
		WideFFmpegSettingPanel
				.add(wideCommandLineInOptionField, grid9_x1_y4_52);
		WideFFmpegSettingPanel.add(new JLabel(OutLabel.getText()),
				grid9_x0_y5_50);
		WideFFmpegSettingPanel.add(wideCommandLineOutOptionField,
				grid9_x1_y5_53);
		WideFFmpegSettingPanel.setForeground(Color.blue);
		// Added FFmpegPathSettingPanel form here
		FFmpegPathSettingPanel.add(FFmpegPathLabel, new GridBagConstraints(0,
				0, 1, 1, 0.0, 0.0, GridBagConstraints.WEST,
				GridBagConstraints.NONE, INSETS_0_5_0_5, 0, 0));
		...
		FFmpegPathSettingPanel.add(FFmpegPathField, new GridBagConstraints(0,
				1, 2, 1, 1.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 5, 0, 0), 0, 0));
		GridBagConstraints grid__x2_y1_108 = new GridBagConstraints(2, 1, 1, 1,
				0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH,
				INSETS_0_5_0_5, 0, 0);
		...
		FFmpegInfoTabPaneEach = getFFmpegInfoTabPaneEach();
		FFmpegInfoTabPaneEach.addTab("変換オプション設定", null, FFMpegTabPanel, null);
		FFmpegInfoTabPaneEach.addTab("FFMpegの位置と機能", null, FFMpegTab2Panel,
				null);
		...
		CommentSaveInfoPanel
				.add(Comment_SaveFolderRadioButton, grid4_x0_y11_18);
		...
		ConvertedVideoSavingInfoPanel.add(
				ShowSavingConvertedVideoFolderDialogButton, grid5_x3_y6_44);
		...
		grid__x_y_000_.fill = GridBagConstraints.HORIZONTAL;
		grid__x_y_000_.insets = INSETS_0_5_0_5;
		OptionalThreadInfoPanel
				.add(OptionalTranslucentCheckBox, grid__x_y_000_);
		...
		CheckDownloadVideoButton
				.setToolTipText("ダウンロード動画をチェック：幅x高さ　fps　映像codec　音声codec");
		CheckDownloadVideoButton.setForeground(Color.blue);
		CheckDownloadVideoButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		...
		CheckFFmpegFunctionPanel.add(new JScrollPane(TextFFmpegOutput),
				grid_x0_y2_87);
		...
		grid20_x0_y2.gridx = 1;
		grid20_x0_y2.gridy = 1;
		grid20_x0_y2.anchor = GridBagConstraints.NORTHWEST;
		...
		experimentPanel.add(fontHeightRatioTextField,grid20_x0_y2);
	}
	...
	private void setPopup() {
		...
		OptionPathField.addMouseListener(new PopupRightClick(
				this.OptionPathField));
		VhookPathField
				.addMouseListener(new PopupRightClick(this.VhookPathField));
		VhookWidePathField.addMouseListener(new PopupRightClick(
				this.VhookWidePathField));
		...
		TextFFmpegOutput.addMouseListener(new PopupRightClick(
				this.TextFFmpegOutput));
		BrowserCookieField.addMouseListener(new PopupRightClick(
				this.BrowserCookieField));
	}
	...
	private ConvertingSetting getSetting() {
		...
		return new ConvertingSetting(MailAddrField.getText(), new String(
				PasswordField.getPassword()), SavingVideoCheckBox.isSelected(),
				...
				SavingOwnerCommentCheckBox.isSelected(), ownercomment,
				...
				ViewCommentField.getText(), FFmpegPathField.getText(),
				VhookPathField.getText(), ExtOptionField.getText(),
				MainOptionField.getText(), CommandLineInOptionField.getText(),
				CommandLineOutOptionField.getText(),
				Integer.toString(back_comment), FontPathField.getText(),
				...
				NGWordTextField.getText(), NGIDTextField.getText(),
				UseProxyCheckBox.isSelected(), ProxyTextField.getText(),
				proxy_port, FixFontSizeCheckBox.isSelected(),
				...
				VideoID_TextField.getText(), VhookWidePathField.getText(),
				UseVhookCheckBox.isSelected(),
				UseVhookWideCheckBox.isSelected(),
				BrowserIECheckBox.isSelected(), BrowserFFCheckBox.isSelected(),
				...
				BrowserCookieField.getText(), OptionPathField.getText(),
				WideFFmpegOptionModel.getSelectedFile(),
				wideExtOptionField.getText(), wideMainOptionField.getText(),
	...
	private void setSetting(ConvertingSetting setting) {
		...
		ConvertWithOwnerCommentCheckBox.setSelected(setting
		...
		AddOption_ConvVideoFileCheckBox.setSelected(setting
				.isAddOption_ConvVideoFile());
		...
		wideCommandLineOutOptionField
				.setText(setting.getWideCmdLineOptionOut());
		wideCommandLineInOptionField.setText(setting.getWideCmdLineOptionIn());
		OptionalTranslucentCheckBox
				.setSelected(setting.isOptionalTranslucent());
	}
	...
	private JTabbedPane FFmpegInfoTabPaneEach = null;
	...
	public void DoButton_actionPerformed(ActionEvent e) {
		if (converter == null || converter.isConverted()) {
			converter = new Converter(VideoID_TextField.getText(),
					...
					new ConvertStopFlag(DoButton, DoButtonStopString,
	...
	public void CheckDownloadVideoButton_actionPerformed(ActionEvent e) {
		...
		try {
			...
			if (converter == null || converter.isConverted()) {
				...
				if (setting.isVideoFixFileName()) {
					...
					if (path == null || path.isEmpty()) {
						TextFFmpegOutput.setText("検索しましたが動画が見つかりません。");
						return;
					}
			...
			ArrayList<String> list = execFFmpeg("-y " + "-i \""
					+ inputVideo.getPath() + "\"");
			for (String line : list) {
				if (line.indexOf("Stream #0.") >= 0) {
					TextFFmpegOutput.append(line.replace("Stream #0.", "")
							.trim() + "\n");
				}
			}
		} catch (NullPointerException ex) {
	...
	private JPanel getConvertingSettingPanel() {
		if (ConvertingSettingPanel == null) {
			...
			ConvertingSettingPanel.add(getExperimentPanel());
			ConvertingSettingPanel.add(getNGWordSettingPanel());
			ConvertingSettingPanel.add(getVhookSettingPanel());
		}
	...
	private JLabel getNGIDLabel() {
		return new JLabel();
	}

	private JLabel getNGWordLavel() {
		return new JLabel();
	}
	...
	private JPanel getProxyInfoPanel() {
		if (ProxyInfoPanel == null) {
			...
			ProxyPortLabel = getProxyPortLabel();
			...
			ProxyLabel = getProxyLabel();
			ProxyLabel.setText("プロキシ");
			ProxyInfoPanel = new JPanel();
			ProxyInfoPanel.setLayout(new GridBagLayout());
			ProxyInfoPanel.setBorder(BorderFactory.createTitledBorder(
					BorderFactory.createEtchedBorder(), "プロキシ設定"));
	...
	private JPanel getVideoSaveInfoPanel() {
		if (VideoSaveInfoPanel == null) {
			...
			GridBagConstraints grid_x3_y5_32 = new GridBagConstraints(3, 4, 1,
					1, 0.0, 0.0, GridBagConstraints.SOUTH,
					GridBagConstraints.NONE, INSETS_0_0_0_5, 0, 0);
			grid_x3_y5_32.gridx = 3;
			grid_x3_y5_32.insets = INSETS_0_0_5_5;
			grid_x3_y5_32.gridy = 5;
			GridBagConstraints grid_x0_y5_30 = new GridBagConstraints(0, 4, 3,
					1, 1.0, 0.0, GridBagConstraints.CENTER,
			...
			GridBagConstraints grid_x0_y4_29 = new GridBagConstraints(0, 3, 4,
					1, 1.0, 0.0, GridBagConstraints.CENTER,
					GridBagConstraints.BOTH, new Insets(0, 25, 0, 5), 0, 0);
			grid_x0_y4_29.gridx = 0;
			grid_x0_y4_29.gridy = 4;
			GridBagConstraints grid_x0_y3_28 = new GridBagConstraints(0, 2, 3,
					1, 1.0, 0.0, GridBagConstraints.WEST,
					GridBagConstraints.BOTH, new Insets(0, 50, 0, 5), 0, 0);
			grid_x0_y3_28.gridx = 0;
			grid_x0_y3_28.gridy = 3;
			GridBagConstraints grid_x0_y2_27 = new GridBagConstraints(0, 1, 4,
					1, 1.0, 0.0, GridBagConstraints.WEST,
			...
			GridBagConstraints grid_x3_y3_31 = new GridBagConstraints(3, 2, 1,
					1, 0.0, 0.0, GridBagConstraints.CENTER,
					GridBagConstraints.NONE, INSETS_0_0_0_5, 0, 0);
			...
			VideoSaveInfoPanel.add(Video_SaveFolderRadioButton, grid_x0_y2_27);
			VideoSaveInfoPanel.add(VideoSavedFolderField, grid_x0_y3_28);
			VideoSaveInfoPanel.add(ShowSavingVideoFolderDialogButton,
					grid_x3_y3_31);
			VideoSaveInfoPanel.add(Video_SaveFileRadioButton, grid_x0_y4_29);
	...
	private JPanel getVideoSavingTabbedPanel() {
		if (VideoSavingTabbedPanel == null) {
			...
			VideoSavingTabbedPanel.add(getVideoSaveInfoPanel(), grid_x_y_36);
			VideoSavingTabbedPanel.add(CommentSaveInfoPanel, grid_x0_y1_37);
			VideoSavingTabbedPanel.add(OwnerCommentInfoPanel, grid_x0_y2_79);
		}
	...
	private JPanel getConvertedVideoSavingTabbedPanel() {
		if (ConvertedVideoSavingTabbedPanel == null) {
			GridBagConstraints grid_x_y_38 = new GridBagConstraints(0, 2, 1, 1,
					1.0, 1.0, GridBagConstraints.NORTH,
					GridBagConstraints.HORIZONTAL, INSETS_0_5_0_5, 0, 0);
			grid_x_y_38.gridx = 0;
			...
			ConvertedVideoSavingTabbedPanel.add(OptionalThreadInfoPanel,
					grid_x_y__);
		}
	...
	private JComboBox getFFmpegOptionComboBox() {
		if (FFmpegOptionComboBox == null) {
			...
			FFmpegOptionComboBox.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
	...
	private JComboBox getWideFFmpegOptionComboBox() {
		if (WideFFmpegOptionComboBox == null) {
			...
			WideFFmpegOptionComboBox.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
	...
	private JButton getFFmpegOptionReloadButton() {
		if (FFmpegOptionReloadButton == null) {
			...
			FFmpegOptionReloadButton.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
	...
	private JPanel getWideFFmpegOptionComboBoxPanel() {
		if (WideFFmpegOptionComboBoxPanel == null) {
			...
			WideFFmpegOptionComboBoxPanel.add(getWideFFmpegOptionComboBox(),
					grid_x_y_2_);
			WideFFmpegOptionComboBoxPanel.add(
					getWideFFmpegOptionReloadButton(), grid_x_y_1_);
		}
