...
public class Stopwatch {
	...
	//	private static String FMT1 = "sïbSSSÉ~Éä";
	private static String FMT1 = "%dïb%03dÉ~Éä";
//	private static String FMT2 = "mï™ssïbSSSÉ~Éä";
	private static String FMT2 = "%dï™%02dïb%03dÉ~Éä";
//	private static String FMT3 = "Héûä‘mmï™ssïbSSSÉ~Éä";
	private static String FMT3 = "%déûä‘%02dï™%02dïb%03dÉ~Éä";
