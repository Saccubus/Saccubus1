...
//	JButton CheckFFmpegInputButton = new JButton();
	...
	private void jbInit() throws Exception {
		GridBagConstraints grid7_x1_y1_74 = new GridBagConstraints(1, 1, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 5), 0, 0);
		grid7_x1_y1_74.gridwidth = 2;
		...
		GridBagConstraints grid5_x3_y7_45 = new GridBagConstraints(3, 5,
				1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.NONE, new Insets(0, 0, 5, 5), 0, 0);
		grid5_x3_y7_45.gridy = 7;
		GridBagConstraints grid5_x3_y5_44 = new GridBagConstraints(3, 3,
				1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.NONE, new Insets(0, 0, 0, 5), 0, 0);
		grid5_x3_y5_44.gridy = 5;
		GridBagConstraints grid5_x0_y7_43 = new GridBagConstraints(0, 5,
				3, 1, 1.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(3, 50, 5, 5), 0, 0);
		grid5_x0_y7_43.gridy = 7;
		GridBagConstraints grid5_x0_y6_42 = new GridBagConstraints(0, 4,
				4, 1, 1.0, 0.0, GridBagConstraints.WEST,
				GridBagConstraints.NONE, new Insets(0, 25, 0, 5), 0, 0);
		grid5_x0_y6_42.gridy = 6;
		GridBagConstraints grid5_x0_y5_41 = new GridBagConstraints(0, 3,
				3, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 50, 0, 5), 0, 0);
		grid5_x0_y5_41.gridy = 5;
		...
		grid5_x0_y4_39.insets = new Insets(0, 50, 0, 0);
...
//		GridBagConstraints grid11_x0_y3_80 = new GridBagConstraints();
		...
		AddTimeStampToCommentCheckBox.setText("コメントファイル名に時刻を付加する");
		AddTimeStampToCommentCheckBox.setForeground(Color.blue);
		AddTimeStampToCommentCheckBox.setToolTipText("過去ログにも現在のコメントにも時刻が付く");
		...
		PathSettingPanel.add(FFmpegPathField, new GridBagConstraints(0, 1, 1,
				...
				GridBagConstraints.BOTH, new Insets(0, 5, 0, 5), 0, 0));
		PathSettingPanel.add(SettingFFmpegPathButton, grid7_x1_y1_74);
		...
		ConvertedVideoSavingInfoPanel.add(ConvertedVideoSavedFolderField,			grid5_x0_y5_41);
		ConvertedVideoSavingInfoPanel.add(ShowSavingConvertedVideoFolderDialogButton,grid5_x3_y5_44);
		ConvertedVideoSavingInfoPanel.add(Conv_SaveFileRadioButton,					grid5_x0_y6_42);
		ConvertedVideoSavingInfoPanel.add(ConvertedVideoSavedFileField,				grid5_x0_y7_43);
		ConvertedVideoSavingInfoPanel.add(ShowSavingConvertedVideoFileDialogButton,	grid5_x3_y7_45);
		...
		CheckFFmpegVersionButton.setText("バージョン");
		...
		GridBagConstraints grid_x0_y0_83 = new GridBagConstraints();
		grid_x0_y0_83.gridx = 0;
		grid_x0_y0_83.weightx = 0.0;
		grid_x0_y0_83.anchor = GridBagConstraints.WEST;
		grid_x0_y0_83.fill = GridBagConstraints.HORIZONTAL;
		grid_x0_y0_83.insets = new Insets(0, 5, 5, 5);
		CheckFFmpegFunctionPanel.add(CheckFFmpegVersionButton, grid_x0_y0_83);
		CheckFFmpegVersionLabel.setText("指定されたFFmpegのバージョンを表示する");
		CheckFFmpegVersionLabel.setForeground(Color.blue);
		GridBagConstraints grid_x1_y0_84 = new GridBagConstraints();
		grid_x1_y0_84.gridx = 1;
		grid_x1_y0_84.weightx = 1.0;
		grid_x1_y0_84.anchor = GridBagConstraints.WEST;
		grid_x1_y0_84.insets = new Insets(5, 5, 5, 5);
		CheckFFmpegFunctionPanel.add(CheckFFmpegVersionLabel, grid_x1_y0_84);
...
//		TextFFmpegOutput.invalidate();
	...
	private void showSaveDialog(String title, JTextField field, boolean isSave,
		...
		String strCDir = CurrentDir.getAbsolutePath();
		...
		if (code == JFileChooser.APPROVE_OPTION) {
			...
			try {
				path = path.replaceFirst(strCDir, ".\\");
	...
	public void CheckDownloadVideoButton_actionPerformed(ActionEvent e){
		if (converter == null || !converter.isConverted()){
			TextFFmpegOutput.setText("ダウンロードが終わっていません。");
			return;
		}
		File inputVideo = converter.getVideoFile();
		if (inputVideo == null || !inputVideo.canRead()){
			TextFFmpegOutput.setText("ダウンロード動画がありません。");
			return;
		}
		TextFFmpegOutput.setText(null);
		ArrayList<String> list = execFFmpeg(
			"-y " + getSetting().getCmdLineOptionIn()
			+ "-i \"" + inputVideo.getPath() + "\"");
		for(int i = 0, j = 0; i < list.size(); i++){
			String line = list.get(i);
			if (line.indexOf("Stream #0") >= 0){
				TextFFmpegOutput.append(line);
				if (++j >= 2) {
					break;
				}
			}
	...
	private ArrayList<String> execFFmpeg(String parameter){
		...
		String cmdstr = "\"" + path + "\" " + parameter;
		String cmd = cmdstr.replace("\\", "/");
