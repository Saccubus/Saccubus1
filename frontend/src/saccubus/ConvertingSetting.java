 ...
 *
 * <p>
 * ê‡ñæ: ÉjÉRÉjÉRìÆâÊÇÃìÆâÊÇÉRÉÅÉìÉgÇ¬Ç´Ç≈ï€ë∂
 * </p>
 *
 * <p>
 * íòçÏå†: Copyright (c) 2007 PSI
 * </p>
 *
 * <p>
 * âÔé–ñº:
...
//	}
	...
	public static void saveSetting(ConvertingSetting setting, String propFile) {
		...
		/*
		 * Ç±Ç±Ç©ÇÁägí£ê›íËï€ë∂ 1.22r3 Ç…ëŒÇ∑ÇÈ
		 */
	...
	public static ConvertingSetting loadSetting(String user,
		...
		return new ConvertingSetting(
			...
			prop.getProperty(PROP_BROWSER_COOKIE_PATH,"Å|èÍèäÇÕé©ï™Ç≈ë{ÇµÇƒâ∫Ç≥Ç¢Å|"),
